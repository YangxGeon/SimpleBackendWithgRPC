...
goog.exportSymbol('proto.books.SearchRequest', null, global);
/**
 ...
 * @constructor
 */
proto.books.SearchRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.books.SearchRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.books.SearchRequest.displayName = 'proto.books.SearchRequest';
}
...
proto.books.Book.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    publishedYear: jspb.Message.getFieldWithDefault(msg, 4, 0)
  };
...
/**
 * optional int32 published_year = 4;
 * @return {number}
 */
proto.books.Book.prototype.getPublishedYear = function() {
 ...
 * @return {!proto.books.Book} returns this
 */
proto.books.Book.prototype.setPublishedYear = function(value) {
 ...
 * @return {!Object}
 */
proto.books.SearchRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.books.SearchRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.books.SearchRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.books.SearchRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.books.SearchRequest}
 */
proto.books.SearchRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.books.SearchRequest;
  return proto.books.SearchRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.books.SearchRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.books.SearchRequest}
 */
proto.books.SearchRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.books.SearchRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.books.SearchRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.books.SearchRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.books.SearchRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTitle();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.books.SearchRequest.prototype.getTitle = function() {
...
/**
 * @param {string} value
 * @return {!proto.books.SearchRequest} returns this
 */
proto.books.SearchRequest.prototype.setTitle = function(value) {
